import random
from code.factory_data_collector import FactoryDataCollector
...
class Simulator:
    def __init__(self,i:int =0,n:int =0,s:int =0,lambd:float=aux.var_lambd,mu:float=aux.var_mu,sigma:float=aux.var_sigma,random_values:bool = True):
        self.__iterations = i
        self.__n = n
        self.__s = s
